...
model.load_state_dict(torch.load("checkpoints/run-1_20260125_133517/checkpoint_epoch_6.pt")["model_state_dict"])
# model.load_state_dict(torch.load("checkpoints/checkpoint_epoch_4.pt"))
model.eval()

model_vs_stockfish(model, model1_name="decoder", num_games=20, temperature=0.0, elo=1700)