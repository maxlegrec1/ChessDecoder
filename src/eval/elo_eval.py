...
def play_game(player1_name, player2_name, engine, model1, model2, temperature=0.1, stockfish_elo=None, game_num=1):
        ...
        with chess.engine.SimpleEngine.popen_uci(STOCKFISH_PATH) as engine:
            ...
            for i in pbar:
                ...
                if i % 2 == 0:
                    ...
                    result, pgn_game = play_game(player1_model_name, player2_stockfish_name, engine, model, None, stockfish_elo=elo, game_num=i+1,temperature=temperature)
                    ...
                    result, pgn_game = play_game(player1_stockfish_name, player2_model_name, engine, None, model, stockfish_elo=elo, game_num=i+1,temperature=temperature)
