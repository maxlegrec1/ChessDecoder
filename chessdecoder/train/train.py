...
from chessdecoder.models.vocab import vocab_size, board_vocab_size, move_vocab_size
...
def train():
    config = load_config("chessdecoder/train/config.yaml")
    ...
    for epoch in range(start_epoch, config["training"]["num_epochs"]):
        ...
        for batch in tqdm(dataloader, disable=not is_main_process()):
            ...
            with torch.no_grad():
                ...
                block_metrics = compute_board_block_metrics(board_correct, board_mask, block_id)
