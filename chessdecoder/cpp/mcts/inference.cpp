...
private:
    static constexpr const char* kVocabPath = "chessdecoder/cpp/mcts/policy_index.txt";
...
private:
    static constexpr const char* kVocabPath = "chessdecoder/cpp/mcts/leela_policy_index.txt";
    std::vector<std::string> tokens;
    std::unordered_map<std::string, int> toIndex;
};
